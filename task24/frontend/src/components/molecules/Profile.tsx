...
export function Profile({
  ...
  const userUrl = photo_profile && `${baseURL}/uploads/user/${photo_profile}`;
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            {...register("full_name")}
            className="placeholder:text-zinc-500 text-lg w-full border-b-1 border-zinc-700 outline-none text-zinc-300 bg-zinc-900 caret-[#04A51E]"
          />
          {errors.full_name && (
