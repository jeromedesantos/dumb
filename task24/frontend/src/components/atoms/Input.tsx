    ...
    return (
      <div className="relative">
        <input
          ...
          placeholder=""
          required
          className="peer w-full px-4 pt-6 pb-2 bg-transparent text-zinc-300 border border-zinc-700 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
        />
        <label
          htmlFor={props.id}
