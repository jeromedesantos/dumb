...
import { repliesKeys, postReplyById } from "../../queries/replies";
...
export function ThreadAdd({
  ...
  const { mutate, isPending, isError, error } = useMutation({
    mutationKey: repliesKeys.detail(threadId as string),
    mutationFn: (formData: FormData) =>
      postReplyById(formData, threadId as string),
  });
  ...
  const userUrl = token?.photo_profile
    ? `${baseURL}/uploads/user/${token.photo_profile}`
    : "/img/profile.jpg";
